...
public class Course_DS {

    public static void main(String[] args) throws IOException {
        try{
            BufferedReader in=new BufferedReader(new FileReader("DS_2023_Spring.txt"));//打开文件创建数据流
            ...
            FileWriter f = new FileWriter("Courses_DS_2023_Spring.txt", false);
